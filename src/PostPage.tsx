...
const PostPage = () => {
    ...
    const getComments = useCallback(async () => {
        try {
            ...
            const responseComments = responsePost.comments.map((responseComment: ResponseCommentType) => {
                return {
            ...
            const sortedComments = responseComments
                .sort((a: { commentId: number }, b: { commentId: number }) => a.commentId - b.commentId)
                .reverse();
